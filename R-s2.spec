...
Version  : 1.1.7
Release  : 32
URL      : https://cran.r-project.org/src/contrib/s2_1.1.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/s2_1.1.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721249261
...
/usr/lib64/R/library/s2/tests/area.Rout.save
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/s2/libs/s2.so
/V4/usr/lib64/R/library/s2/libs/s2.so
